...
class DesignedArc(object):
    ...
    def __init__(self, id, type, dn_up, dn_down, ls_section, arc_cost, diameter, flow, slope, length, normal_depth, angle,
                 radius, area, speed, tau, froude):
        """"
        Constructor Method: Designed Arc (Hydraulic Design Problem)
        :param id
        :param type pipe or manhole/pump
        :param dn_up
        :param dn_down
        :param ls_section
        :param arc_cost
